 ...
 */
export declare const getStartIndex: (solarDateStr: string, timeIndex: number, fixLeap?: boolean) => {
    ziweiIndex: number;
    tianfuIndex: number;
};
/**
 ...
 * @returns 三台，八座索引
 */
export declare const getDailyStarIndex: (solarDateStr: string, timeIndex: number) => {
    santaiIndex: number;
    bazuoIndex: number;
    enguangIndex: number;
    tianguiIndex: number;
 ...
 */
export declare const getYearlyStarIndex: (solarDate: string, timeIndex: number, fixLeap?: boolean) => {
    xianchiIndex: number;
    huagaiIndex: number;
    guchenIndex: number;
    guasuIndex: number;
